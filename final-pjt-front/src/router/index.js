...
import GenreMovieView from '@/views/GenreMovieView.vue'
...
const routes = [
  ...
  */
  ...
  {
    path: '/profile/:username/edit',  // /profile/neo
    name: 'profileEdit',
  ...
  {
    path: '/movies/:moviePk',  // moviedetail
    name: 'movie',
    component: MovieDetailView,
  },
  {
    path: '/movies/genremovies/:genrePk',  // genremovies
    name: 'genremovies',
