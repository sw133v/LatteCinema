        ...
        <div class="card card-6">
            ...
            <div class="card-body">
                <form @submit.prevent="onSubmit">
                  <div class="form-row">
                      <div class="name">게시글 제목</div>
                      <div class="value">
                          <input class="input--style-6" v-model="newArticle.title" type="text" id="title">
                      </div>
                  </div>
                  <div class="form-row">
                      ...
                      <div class="value">
                          <div class="input-group">
                              <textarea class="textarea--style-6" v-model="newArticle.content" type="text" id="content" placeholder="내용을 넣어주세요!"></textarea>
                          </div>
                      </div>
                  </div>
                  <div class="card-footer">
                      <button class="btn btn--radius-2 btn--blue-2" type="submit">{{ action }}</button>
                  </div>
                </form>
            </div>
        </div>
